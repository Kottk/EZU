...
public class CoolantTemp extends ECUSensor
{
    /**
     * Represents the speed the vehicle is moving in km/h.
     */
    public Integer degC = 0;
    /**
     * Key for ECUInitializer's HashMap.
     */
    public final String KEY = "CT";


    /**
     * Called by CoolantTemp constructor, adds this new object to the ECUInitializer's HashMap.
     *
     ...
     */
    public CoolantTemp(ECUInitializer eI)
    {
        addToMap(eI);
    }
    /**
     * Getter method for degC field.
     *
    ...
    /**
     *  This method interprets the response received from the ECU and sets the degC field.
     *
